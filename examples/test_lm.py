...
if __name__ == "__main__":
    ...
    parser.add_argument('--G-inter', help='degree of inter-layer parallelism', type=int, default=1)
    parser.add_argument('--G-data', help='degree of data parallelism', type=int, default=1)
    parser.add_argument('--micro-batch-size', help='micro batch size', type=int, default=4)
    ...
    parser.add_argument('--sequence-length', help='sequence length of each data point', type=int, default=512)
    parser.add_argument('--dataset', help='which dataset to use', choices=['wikitext', 'ptb'], type=str, default='wikitext')
    parser.add_argument('-N', '--num-hidden-layers', help='number of transformer layers',type=int, default=24)
    parser.add_argument('-D','--hidden-size',help='hidden size of transformer',type=int,default=1024)
    parser.add_argument('-H','--num-attention_heads',help='number of attention heads',type=int,default=16)
    parser.add_argument('--cpu-offload', help='offload fp32 params, fp32 grads and optimizer states to cpu', action='store_true', default=False)
